...
// =============================================================================
export const getGiftItemsCollRef = (userId: string) => collection(db, 'users', userId, 'giftItems');
export const getGiftItemDocRef = (userId: string, giftItemId: string) => doc(db, 'users', userId, 'giftItems', giftItemId);